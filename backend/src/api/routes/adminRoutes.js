...
router.put('/drivers/:id/status', validateAdminActions, AdminController.updateDriverStatus);
router.get('/stats', AdminController.getSystemStats);
router.put('/profit-percentage', validateAdminActions, AdminController.manageProfitPercentage);
